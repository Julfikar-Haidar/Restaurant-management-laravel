...
<html lang="en">
    <head>
        ...
        <!-- <link rel="shortcut icon" href="star.png" type="favicon/ico" /> -->
    ...
    @endforeach
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2019 developed by <a href="https://julfikar-haidar.github.io/portfolio/" target="_blank">Julfikar Haidar</a></a> Theme by <a href="http://themewagon.com/"  target="_blank">ThemeWagon</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <script type="text/javascript" src="j{{asset('frontend/js/jquery.hoverdir.js')}}"></script>
